    ...
    public void writePDF(BufferedImage diagram)
    {
        try
        {
            ...
            if (diagram != null)
            {
                ...
                document.add(image);
                document.newPage(); // Force a new page after the image
            }
            ...
            //                document.add(new Paragraph("Prerequisites: " + (node.prerequisites.isEmpty() ? "None" :
            //                String.join(", ", node.prerequisites))));
